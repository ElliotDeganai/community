<template>
    <div :class="[delete_modal ? 'h-screen overflow-hidden' : '']" class="bg-white relative" style="font-family:  'Kalam', cursive;">
...
<!--
            ...
            <div :class="[product ? 'h-screen overflow-hidden' : 'min-h-screen h-full']" class="relative w-full">
                ...
                <div class="relative h-full min-h-screen">
                    ...
                    <div class="w-full absolute bottom-0 left-0 h-24 bg-black opacity-50 blur-lg z-50">
                    </div>
...
import Loading from '../Pages/Home/Client/Help/LoadingBase.vue';
import Navbar from './NavbarBase.vue'
import NavMobile from './NavMobileBase.vue'
