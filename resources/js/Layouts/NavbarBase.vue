<template>
    <nav :class="[((scrollPosition === null && $page.url !== '/resume') || (scrollPosition < 0.1 && $page.url !== '/resume')) ? 'border-b' : 'border-b bg-white']" class="fixed top-0 w-full border-gray-200 z-60">
