<template>
    <div class="w-full text-white relative">
        <div class="w-full h-full bg-white opacity-25 absolute top-0"></div>
        <div class="w-full py-8">
            <div class="uppercase text-3xl text-white w-full text-center">They speak about us</div>
        </div>
        <div class="w-full py-4 md:py-8 relative">
            <div v-if="videos.length > 4">
                <div class="relative overflow-hidden w-full h-64 lg:h-70 hidden md:block ">
                    <div :style="'left: '+collection.position+'%;'" class="w-1/3 md:w-1/4 collection lg:w-1/4 p-2 md:p-4 absolute top-0" :key="collection.index" v-for="collection in this.getlist">
                        <div class="p-2">
                            <div class="w-full relative overflow-hidden group navbar">
                                <img :src="collection.article.image" class="object-cover w-full h-32 md:h-48 lg:56 transition duration-500 ease-in-out transform group-hover:scale-125" />
                        ...
                        <div class="w-full text-center uppercase">{{collection.article.name}}</div>
                    </div>
                </div>
                <div class="relative overflow-hidden w-full h-56 block md:hidden ">
                    <div :style="'left: '+collection.positionM+'%;'" class="w-1/2 md:w-1/3 collection lg:w-1/4 p-2 md:p-4 absolute top-0" :key="collection.index" v-for="collection in this.getlist">
                        <div class="p-2">
                            <div class="w-full relative overflow-hidden group navbar">
                                <img :src="collection.article.image" class="object-cover w-full h-40 md:h-56 transition duration-500 ease-in-out transform group-hover:scale-125" />
            ...
            <div v-else>
                <div class="relative overflow-hidden w-full h-64 lg:h-70 hidden md:flex flex-wrap justify-center">
                    <div class="w-1/3 md:w-1/4 lg:w-1/4 p-2 md:p-4" :key="collection.index" v-for="collection in this.videos">
                        <div class="p-2">
                            <div class="w-full relative overflow-hidden group navbar">
                                <img :src="collection.article.image" class="object-cover w-full  h-32 md:h-48 lg:56 transition duration-500 ease-in-out transform group-hover:scale-125" />
                                <div class="absolute group-hover:block hidden bg-blue-900 top-0 left-0 w-full  h-32 md:h-48 lg:56 opacity-50" />
                ...
                <div class="relative overflow-hidden w-full h-56 flex flex-wrap justify-center md:hidden ">
                    <div class="w-1/2 md:w-1/3 lg:w-1/4 p-2 md:p-4" :key="collection.index" v-for="collection in this.videos">
                        <div class="p-2">
                            <div :src="collection.article.image" class="w-full relative overflow-hidden group navbar">
                                <img class="object-cover w-full h-40 md:h-56 transition duration-500 ease-in-out transform group-hover:scale-125" />
                                <div class="absolute group-hover:block hidden bg-blue-900 top-0 left-0 w-full h-40 md:h-56 opacity-50" />
                                <div class="absolute group-hover:flex hidden w-full h-full top-0 left-0 flex-wrap justify-center content-center">
                                    <div class="text-white font-bold">Voir le détail</div>
                                </div>
