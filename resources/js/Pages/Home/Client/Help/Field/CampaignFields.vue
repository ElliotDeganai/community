<template>
    <div class="">
        <div>
            <div class="">
                <div class="py-4">
                    <label class="label-fields-client" for="title">Nom de ton secret santa</label>
                    <div class="py-2">
                ...
                <div class="py-4 hidden">
                    <label class="label-fields-client" for="slug">Slug</label>
                    <div class="py-2">
                ...
                <div class="py-4">
                    <label class="label-fields-client" for="body">Description de votre secret santa qui sera visible par tous les membres</label>
                    <div class="py-2">
                ...
                <div v-if="startCategory === null" class="py-4 hidden">
                    <label class="label-fields-client"  for="category">Template</label>
                ...
                <div v-else class="py-4 hidden">
                        <div class="bg-white w-1/5 text-red-900 font-bold uppercase px-3 py-2 rounded-md">Template: {{model.category_id.name}}</div>
                </div>
                <div class="py-4 hidden">
                    <label class="label-fields-client"  for="published">Published</label>
                    <div class="py-2">
                ...
                <div class="py-4 hidden">
                    <label class="label-fields-client" for="excerpt">Excerpt</label>
                    <div class="py-2">
            ...
            <div>
                <div  class="header-config-client hidden">
                    Related
                </div>
                <div  class="hidden" v-if="parentCategory">
                    <label class="label-fields-client">Parent post</label>
                    <div v-if="parent === null" class="py-2">
                    ...
                    <div v-else class="py-4">
                            <div class="bg-white w-1/5 text-red-900 font-bold uppercase px-3 py-2 rounded-md">Parent: {{parentPost.name}}</div>
                    </div>
                </div>
            ...
            <div class="">
                <div class="py-8" v-if="model.category_id !== null">
                    ...
                    <div class="w-full" :key="attribute.id" v-for="(attribute, index) in model.category_id.documentations">
                        <label class="label-fields-client" :for="'doc_'+attribute.id">{{ attribute.name }}</label>
...
import '../../../../Help/RichText.vue'
import RichText from '../../../../Help/RichText.vue'
import FileInput from '../../../../Help/File/FileInput.vue'
import FilesInput from '../../../../Help/File/FilesInput.vue'
...
/*         setChildCatgory(){
    ...
    created() {
        ...
        if (this.getparent) {
            this.model.post_id = this.parent
        }
    },
    mounted() {
    },
