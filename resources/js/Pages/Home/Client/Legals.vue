                        ...
                        <div class="w-full">
                            <div class="container-py-inside" v-if="$helpers.getFieldDocValueObject(field, legal) !== ''">
                                <div class="w-full flex">
                                    ...
                                    <div class="container-px-inside" v-if="field.name == 'Content'">
...
export default {
    ...
    data() {
        return{
            page: this.$page.props.pages.filter(page => page.title == 'Mentions Légales')[0],
            section_legal: this.$page.props.pages.filter(page => page.title == 'Mentions Légales')[0].page_sections[0],
            legal: this.$page.props.pages.filter(page => page.title == 'Mentions Légales')[0].page_sections[0].category.posts[0]
        }
    },
    methods: {
        formatDateFr(date){
