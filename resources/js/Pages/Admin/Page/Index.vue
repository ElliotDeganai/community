<template>
    <div class="container-px-inside-lg">
        ...
        <div>
            <div>
                ...
                <div class="container-py-inside-md">
                    <Link :href="route('pages.create')"  class="post-content font-bold bg-gray-800 px-3 py-2 rounded-md text-white">
                        Add a new page
                    </Link>
                </div>
                <div v-if="pages.length !== 0" class="w-full">
                    <div class="w-full">
                        <div class="w-full font-bold flex flex-wrap container-py-field border-b-2 border-gray-800">
                            <div class="page-index-collapse">
                            </div>
                            <div class="page-index-visible">Title</div>
                            <div class="page-index-visible">URL</div>
                            <div class="page-index-invisible">Categories count</div>
                            <div class="page-index-invisible">Published</div>
                            <div class="page-index-invisible">Published at</div>
                        </div>
                    </div>
                    <div class="w-full">
                        <div class="w-full" :key="page.id" v-for="page in pages">
                            <div class="w-full flex flex-wrap container-py-field border-b border-gray-200">
                                <div class="page-index-collapse py-2">
                                ...
                                <div class="page-index-visible py-2">
                                    <Link :href="route('pages.edit', page.id)" class="">
                                        {{page.title}}
                                    </Link>
                                </div>
                                <div class="page-index-visible py-2">{{page.url}}</div>
                                <div class="page-index-invisible py-2">{{page.categories_count}}</div>
                                <div class="page-index-invisible py-2">{{page.published}}</div>
                                <div class="page-index-invisible py-2">{{formatDate(page.published_at)}}</div>
                ...
                <div class="flex flex-wrap container-py-inside-md justify-center w-full">
