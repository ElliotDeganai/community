<template>
    <div class="container-px-lg post-text-normal">
        ...
        <div  class="" v-if="$page.props.auth.isDev || $page.props.auth.isAdmin || $page.props.auth.isEditor">From this page you can create your resources and their associated documentation values</div>
        <div v-if="type && getcategories[0] && ($page.props.auth.isDev || $page.props.auth.isAdmin || $page.props.auth.isEditor)" class="container-py-inside-md post-content">
