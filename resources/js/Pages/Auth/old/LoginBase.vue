...
import BreezeGuestLayout from '@/Layouts/Default.vue';
...
<template>
    <BreezeGuestLayout class="relative text-slate-900">
        ...
        <div class="pt-32 w-full h-full absolute top-0 left-0">
            ...
            <div class="py-24    lg:py-32 relative">
                <div class="text-xl font-bold w-full lg:pb-24">
                    <div class="w-full font-bold text-xl lg:text-3xl text-center">Connecte-toi</div>
                </div>
            </div>
            <Head title="Log in" />
...
<!--                     <div class="block mt-4">
                    ...
                    <div class="flex justify-around mt-4">
                       <Link v-if="canResetPassword" :href="route('password.request')" class="underline py-4 text-sm ">
